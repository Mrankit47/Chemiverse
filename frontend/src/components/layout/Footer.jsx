  ...
  return (
    <footer data-testid="main-footer" className="relative border-t border-[rgba(0,245,255,0.15)] mt-16 sm:mt-24 bg-[#050816]/80 backdrop-blur-lg">
      ...
      <div className="border-b border-[rgba(0,245,255,0.1)] py-3 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-3 text-[11px] font-mono text-[var(--muted)]">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-[var(--green)] pulsering" />
            <span className="text-[#E6F7FF]">CHEMIVERSE CORE ENGINE // V2.4.0</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-14 grid gap-8 sm:gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
        <div className="sm:col-span-2">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-8 rounded-lg glass grid place-items-center border border-[rgba(0,245,255,0.3)] shadow-[0_0_12px_rgba(0,245,255,0.2)]">
              <Atom className="w-5 h-5 text-[var(--cyan)]" />
            </div>
        ...
        <div>
          <h4 className="font-mono text-xs uppercase tracking-[0.15em] text-[var(--cyan)] mb-4">Simulation Modules</h4>
        ...
        <div>
          <h4 className="font-mono text-xs uppercase tracking-[0.15em] text-[var(--purple)] mb-4">Research & Tools</h4>
          <ul className="space-y-2.5">
